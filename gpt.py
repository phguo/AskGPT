...
if __name__ == '__main__':
    params = sys.argv[1:]
    api_key, model, temprature, messages, signature, print_input, chat_number, api_base = pre_process(*params)
    if messages[-1].get("content", None):
        messages = ask_gpt(api_key, model, temprature, messages, signature, print_input, api_base)
